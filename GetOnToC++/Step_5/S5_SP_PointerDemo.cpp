...
int main() 
{
    ...
    if (yPtr != NULL) // succeeds if yPtr is not null
        cout << "yPtr is not null" << endl;
    else if (yPtr == NULL) // succeeds if yPtr is null
    ...
    if (yPtr == &y) cout << "yPtr and y point to the same location" << endl;
    else cout << "yPtr and y point to different location" << endl;
